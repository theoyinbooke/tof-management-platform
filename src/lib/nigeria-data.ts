...
export const localGovernmentAreas: Record<string, string[]> = {
  Abia: [
    "Aba North",
    "Aba South",
    "Arochukwu",
...
// For states not in the list above, provide a default set
...
export function getLGAsForState(state: string): string[] {
  return localGovernmentAreas[state] || defaultLGAs;
}
